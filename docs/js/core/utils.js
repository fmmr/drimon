...
const Utils = {
    ...
    /**
     * Determine unit for a chart based on its ID or config
    ...
    getUnitForChart: function(chartIdOrConfig) {
        // If config object with unit is provided
        ...
        // Try to find config by ID in global chartConfigs
        ...
        // Default unit mapping based on chart ID
    ...
    shouldUseIntegerValues: function(config) {
        ...
        if (config && config.id && window.chartConfigs) {
